...
<head>
    ...
    * {
    ...
    .open-button {
        background-color: rgb(251, 209, 119);
        color: rgb(0, 0, 0);
        padding: 15px;
        border: none;
        border-radius: 4pc;
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center site-vh-100">
                <div class="col-md-12">
                    ...
                    <p><a class="btn btn-outline-white btn-lg site-animate" href="reservation.php">Reservation</a></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center mb-5 site-animate">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            <p class="lead">If you have any Suggestion you can send it to our Email.</p>
                        </div>
                    </div>
                </div>

                <div class="col-md-7 mb-5 site-animate">
                    <form action="mailto:info@yoursite.com" method="post">
                ...
                <div class="col-md-4 site-animate">
                    ...
                    <p class="text-black">
                        Email: <br> <a href="mailto:info@yoursite.com">alexander.remains.1247@gmail.com</a>
                        <br> <a href="mailto:info@yoursite.com">mflorenceabigail@yahoo.com</a>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-md-4 site-animate">
                            ...
                            <p>This Website Created by Alexander Grace and Michelle Florence<br>
                                ...
                                -> alexander.remains.1247@gmail.com <br>
                                Thank you.
                            </p>
                        </div>
